...
class VFSPath:
    ...
    def joinpath(self, *other: os.PathLike[str] | str) -> VFSPath:
        return VFSPath(self._path.joinpath(*other), self._filesystem)

    def __str__(self) -> str:
        return str(self._path)

    def __truediv__(self, other: str | os.PathLike[str]) -> VFSPath:
        return self.joinpath(other)

    def __eq__(self, other: object) -> bool:
        if not isinstance(other, VFSPath):
            return False
